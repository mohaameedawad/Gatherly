...
export interface Session{id:number;conferenceId:number;title:string;abstract:string;track:string;room:string;startsAt:string;endsAt:string;capacity:number;speakerId:number}
