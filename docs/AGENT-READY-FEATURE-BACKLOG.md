...
| US-2.1  | Create a conference draft                   | Not started |
...
| US-3.1  | Create and edit a session                   | Not started |
| US-3.2  | Cancel or delete a session                  | Not started |
| US-3.3  | Browse and filter the schedule              | Not started |
